...
#[airports, planes, legs, rot_times] = p.load(f)

# =============================================================================
# A= p.build_graph(legs)
#x= Graph.nodes(A)
# =============================================================================
p.state = ['LPPT LPPR 0095 45', 'LPPR LPPT 0058 89', 'LPPT LPFR 0085', 'LPPT LPMA 0146']
print (p.goal_test(p.state))
print (p.heuristic(p.state))
# =============================================================================
